...
Tags: featured page, genesis, widget, featured content, genesiswp
...
Genesis Featured Page Advanced is only for Genesis Framework users. Genesis is a premium product of [StudioPress](http://www.studiopress.com), which has no affiliation with this plugin.
...
= 1.9.9 - 2021/9/02 =
* Fixed deprecated function error message (Thanks @hanswitteprins!)
